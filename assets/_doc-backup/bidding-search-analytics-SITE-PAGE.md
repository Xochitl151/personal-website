...
findings:
  ...
  - title: 付费渠道意图与落地页匹配偏弱
    detail: 「付费推广」带来访问量，但停留与点击弱于直接访问、站内来源。
    action: 复核推广落地页与搜索意图是否一致，再观察下一周期 CTR 与停留。
demos:
  - bidding-insights
  - chart-gallery
charts:
  - src: /images/projects/bidding-search/tableau-dashboard-full.jpg
    label: 仪表板
...
lenses:
  - id: data
    ...
    bullets:
      ...
      - 发现按观察、可能原因、建议验证写出；不做因果断言。
      - 与实习「用户套餐分析」不是同一份数据。
  - id: ai
    label: 产品与交付
    bullets:
      - 练习上线检索产品后如何看关键词与渠道数据。
...
disclaimer: 个人练习。与实习用户套餐分析、招投标建站项目分开，仅作关键词分析与 Tableau 方法演示。
---
